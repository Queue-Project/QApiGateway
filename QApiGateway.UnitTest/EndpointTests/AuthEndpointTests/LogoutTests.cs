...
public class LogoutTests
{
    ...
    [Fact]
    public async Task Logout_Should_Return_Logged_Out()
    {
        // Arrange
        string refreshToken = "11111.22222.33333";
        
        var expectedResponse = "{Logged out}";
        ...
        // Act
        var result = await AuthEndpointHandlers.LogoutHandler(
            client,
