...
public class VerifyEmailTests
{
    ...
    [Fact]
    public async Task Verify_Should_Return_Verified_Email()
    {
        // Arrange
        ...
        var expectedResponse = "{Verified successfully}";
        ...
        // Act
        var result = await AuthEndpointHandlers.VerifyEmailHandler(
            client,
            request);
