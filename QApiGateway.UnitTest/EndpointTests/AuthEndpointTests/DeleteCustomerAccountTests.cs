...
public class DeleteCustomerAccountTests
{
    ...
    [Fact]
    public async Task DeleteCustomerAccount_Should_Return_Deleted_Account_When_Authorized()
    {
        // Arrange
    
        var expectedResponse = "{Account deleted}";
        ...
        // Act
        var result = await AuthEndpointHandlers.DeleteCustomerAccountHandler(
            client,
            context.Request);
