...
namespace QApiGateway.UnitTest.EndpointTests.ReportEndpointTests;
...
public class GetCustomerReportTests
{
    ...
    [Fact]
    public async Task GetCustomerReport_Should_Return_CustomerReport_When_Authorized()
    {
        ...
        // Arrange
        var expectedResponse = "{customerQueues: id= 1, companyId = 1}";
        ...
        // Act
        var result = await ReportEndpointHandlers.GetCustomerReport(
            client,
