...
public class GetCustomerReviewHistoryTests
{
     private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public GetCustomerReviewHistoryTests()
    {
    ...
    [Fact]
    public async Task GetCustomerReviews_Should_Return_CustomerReviews_When_Authorized()
    {
        // Arrange
        int pageNumber = 1;
        ...
        // Act
        var result = await ReviewEndpointHandlers.GetCustomerReviewHistory(
            client,
