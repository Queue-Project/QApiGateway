...
public class CancelQueueByCustomerTests
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public CancelQueueByCustomerTests()
    {
    ...
    [Fact]
    public async Task CancelQueue_Should_Return_CancelledQueue_When_Authorized()
    {
        // Arrange
        var request = new QueueCancelRequest
        {
            QueueId = 1,
            CancelReason = "Test Cancel Reason"
        };
        var expectedResponse = "{queue: id=1, status=CancelledByCustomer";
        ...
        // Act
        var result = await QueueEndpointHandlers.CancelQueueByCustomerHandler(
            client,
    ...
    [Fact]
    public async Task CancelQueue_Should_Return_Error_When_Queue_Not_Found()
    {
        // Arrange
        var request = new QueueCancelRequest
        {
