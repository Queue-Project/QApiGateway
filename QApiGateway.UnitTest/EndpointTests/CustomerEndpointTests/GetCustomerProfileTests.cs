...
public class GetCustomerProfileTests
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public GetCustomerProfileTests()
    {
    ...
    {
        // Arrange
        var expectedResponse = "{customer: id=1, name= Test Name}";
        ...
        // Act
        var result = await CustomerEndpointsHandlers.GetCustomerProfile(
            client,
            context.Request);
