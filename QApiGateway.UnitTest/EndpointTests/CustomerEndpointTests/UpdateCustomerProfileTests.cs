...
namespace QApiGateway.UnitTest.EndpointTests.CustomerEndpointTests;

public class UpdateCustomerProfileTests
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public UpdateCustomerProfileTests()
    {
    ...
    [Fact]
    public async Task GetCustomerProfile_Should_Return_CustomerProfile_When_Authorized()
    {
        // Arrange
        ...
        var expectedResponse = "{customerProfile: id=1, FirstName = Test Name, LastName= Test Name}";
        ...
        // Act
        var result = await CustomerEndpointsHandlers.UpdateCustomerProfile(
            client,
    ...
    [Fact]
    public async Task GetCustomerProfile_Should_Return_Error_When_Profile_Not_Found()
    {
        // Arrange
        var request = new UpdateProfileRequest
        {
        ...
        var expectedResponse = "{error: Profile not found}";
        var token = "Bearer test-token";
