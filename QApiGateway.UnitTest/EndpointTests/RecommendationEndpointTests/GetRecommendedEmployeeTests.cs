...
public class GetRecommendedEmployeeTests
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public GetRecommendedEmployeeTests()
    {
    ...
    [Fact]
    public async Task GetRecommendedEmployee_Should_Return_RecommendedEmployees_When_Authorized()
    {
        var request = new RecommendedEmployeeRequest
        {
            CompanyId = 1,
            BranchId = 1,
            ServiceId = 1,
        ...
        // Arrange
        var expectedResponse = "{Items: EmployeeId= 1, EmployeeName = TestName}";
        ...
        // Act
        var result = await RecommendationEndpointHandler.GetRecommendedEmployees(
            client,
