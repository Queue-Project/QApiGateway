...
public class GetRecommendedServicesTests
{
    ...
    [Fact]
    public async Task GetRecommendedServices_Should_Return_RecommendedServices_When_Authorized()
    {
        var request = new RecommendedServiceRequest
        {
            CompanyId = 1,
            BranchId = 1,
            PageNumber = 1,
        ...
        // Arrange
        var expectedResponse = "{Items: ServiceId= 1, ServiceName = TestName}";
        ...
        // Act
        var result = await RecommendationEndpointHandler.GetRecommendedServices(
            client,
