...
public class GetRecommendedCompaniesTests
{
    ...
    [Fact]
    public async Task GetRecommendedCompanies_Should_Return_RecommendedCompanies_When_Authorized()
    {

        var request = new RecommendedCompanyRequest
        {
            CategoryId = 1,
            PageNumber = 1,
        };
        ...
        // Arrange
        var expectedResponse = "{Items: CompanyId= 1, CompanyName = TestName}";
        ...
        // Act
        var result = await RecommendationEndpointHandler.GetRecommendedCompanies(
            client,
