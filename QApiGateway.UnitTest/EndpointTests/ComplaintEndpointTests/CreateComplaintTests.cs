...
public class CreateComplaintTests
{
    ...
    [Fact]
    public async Task CreateComplaint_Should_Return_CreateComplaint_When_Authorized()
    {
        // Arrange
        ...
        // Act
        var result = await ComplaintEndpointsHandlers.CreateComplaintHandler(
            client,
    ...
    [Fact]
    public async Task CreateComplaint_Should_Return_Error_When_Queue_Not_Found()
    {
        // Arrange
        var request = new ComplaintCreateRequest
        {
