...
public class DeleteEmployeeFromFavoriteListTests
{
     private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public DeleteEmployeeFromFavoriteListTests()
    {
    ...
    [Fact]
    public async Task DeleteEmployeeFromFavoriteList_Should_Return_NoContent_When_Authorized()
    {
        // Arrange
        var EmployeeId = 1;
        ...
        // Act
        var result = await FavoriteEmployeesEndpointHandler.DeleteEmployeeFromFavoriteList(
            client,
    ...
    [Fact]
    public async Task DeleteEmployeeFromFavoriteList_Should_Return_Error_When_Employee_Not_Found()
    {
        // Arrange
        var EmployeeId = 1;
