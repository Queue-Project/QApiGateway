...
public class GetCompanyInfoByIdTests
{
    private readonly Mock<HttpMessageHandler> _mockHttpMessageHandler;
    private readonly HttpClient _httpClient;
    private readonly WebApplication _app;

    public GetCompanyInfoByIdTests()
    {
    ...
    [Fact]
    public async Task GetCompanyInfoById_Should_Return_CompanyInfo_When_Authorized()
    {
        // Arrange
        var companyId = 1;
        var expectedResponse = "{company: id=1, name= Test Name}";
        ...
        // Act
        var result = await CompanyEndpointsHandlers.GetCompanyInfoById(
            client,
            context.Request,
            companyId);
    ...
    [Fact]
    public async Task GetCompanyInfoById_Should_Return_Error_When_Company_Not_Found()
    {
        // Arrange
        var companyId = 1;
